...
"""
Calls the heart function and sets the user input
"""
def sendHeart():
...
"""
Prints both top and bottom heart's parts
"""    
def heart(width):
    upBody(width)
    downBody(width)
...
"""
Prints the bottom part, which looks like an upside down tree
"""   
def downBody(length):
    stars=length
    leftSpaces=0
...
print("Send love by giving a correct odd number (>=7 & <=45)")
sendHeart()